...
$global_name = $_POST["gname"];
$global_description = $_POST["gdesc"];
$global_title = $_POST["gtitle"];
$host = $_POST["mhost"];
$user = $_POST["muser"];
$pass = $_POST["mpass"];
$db = $_POST["mdb"];
$suffix = $_POST["msuffix"];
...
$file = fopen('conf.min.php','a+');

if ($file) {
	ftruncate($file, 0);
	rewind($file);
	if (!fwrite($file, $code)) die('Cloud not create the file!');
